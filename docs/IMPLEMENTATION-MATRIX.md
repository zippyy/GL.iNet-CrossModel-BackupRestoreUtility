...
| Archive v2 | Dedicated prefix, strict file/directory-only members, traversal/duplicate rejection, validated manifest identity, exact SHA-256 payload coverage and legacy-v1 labeling | Large archives on low-memory devices |
