...
# Encoded LuCI controller that creates the otherwise missing Services parent menu.
mkdir -p "$work/data/usr/lib/lua/luci/controller"
printf '%s' '' | base64 -d > "$work/data/usr/lib/lua/luci/controller/glinet_crossmodel_menu.lua"
